...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			m_MouseLook.Init(upbody.transform, m_Camera.transform);
        }
        ...
        {
            RotateView();
           // transform.Rotate(upbody.transform.position * 10);
        ...
        private void FixedUpdate()
        {
            ...
            Vector3 desiredMove = upbody.transform.forward*m_Input.y + upbody.transform.right*m_Input.x;
        ...
        {
            m_MouseLook.LookRotation (upbody.transform, m_Camera.transform);
        }
